...
public class EmployeeDao {
	...
	public static Employee saveEmployee(Employee employee,int dept_id)
	{
	...
	public static Employee updateEmployee(Employee employee,int dept_id)
	{
		Department d=manager.find(Department.class,dept_id);
		if(d!=null)
		{
	...
	public static List<Employee> findEmpsByDeptId(int id)
	{
	...
	public static List<Employee> findEmpsByDeptName(String name)
	{
	...
	public static Employee verifyEmp(int id,String password)
	{
	...
	public static Employee verifyEmp(String email,String password)
	{
	...
	public static Employee verifyEmp(long phone,String password)
	{
